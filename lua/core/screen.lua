...
--- set red level (color/brightness).
-- @tparam number value 0-15 (0=off, 15=red)
Screen.rlevel = function(value) _norns.screen_rlevel(value) end
--- set green level (color/brightness).
-- @tparam number value 0-15 (0=off, 15=green)
Screen.glevel = function(value) _norns.screen_glevel(value) end
--- set blue level (color/brightness).
-- @tparam number value 0-15 (0=off, 15=blue)
Screen.blevel = function(value) _norns.screen_blevel(value) end
