...
static float cred[19] = {0,   0.066666666666667, 0.13333333333333, 0.2, 0.26666666666667, 0.33333333333333,
                      0.4, 0.46666666666667,  0.53333333333333, 0.6, 0.66666666666667, 0.73333333333333,
                      0.8, 0.86666666666667,  0.93333333333333, 1, 1,0,0};

static float cgreen[19] = {0,   0.066666666666667, 0.13333333333333, 0.2, 0.26666666666667, 0.33333333333333,
                      0.4, 0.46666666666667,  0.53333333333333, 0.6, 0.66666666666667, 0.73333333333333,
                      0.8, 0.86666666666667,  0.93333333333333, 1,0,1,0};

static float cblue[19] = {0,   0.066666666666667, 0.13333333333333, 0.2, 0.26666666666667, 0.33333333333333,
                      0.4, 0.46666666666667,  0.53333333333333, 0.6, 0.66666666666667, 0.73333333333333,
                      0.8, 0.86666666666667,  0.93333333333333, 1,0,0,1};
...
void screen_level(int z) {
    ...
    if(z<0)
        ...
        z=19;
    cairo_set_source_rgb(cr, cred[z], cgreen[z], cblue[z]);
}

void screen_rlevel(int z) {
    CHECK_CR
    if(z<0)
        z=0;
    else if(z>15)
        z=15;
    cairo_set_source_rgb(cr, cred[z], 0, 0);
}

void screen_glevel(int z) {
    CHECK_CR
    if(z<0)
        z=0;
    else if(z>15)
        z=15;
    cairo_set_source_rgb(cr, 0, cgreen[z], 0);
}

void screen_blevel(int z) {
    CHECK_CR
    if(z<0)
        z=0;
    else if(z>15)
        z=15;
    cairo_set_source_rgb(cr, 0, 0, cblue[z]);
}

void screen_rgblevel(int r, int g, int b) {
    CHECK_CR
    if(r<0)
        r=0;
    else if(r>15)
